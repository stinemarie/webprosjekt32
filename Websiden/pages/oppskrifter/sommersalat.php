<h4>Sommersalat med jordbær, eple, kraftkar og tind spekeskinke (3porsjoner)</h4>
<ul>
	<li>1 pakke Tind godt modnet spekeskinke</li>
	<li>ca. 100 g Blandet salat</li>
	<li>1/2 Rødløk, i tynne båter</li>
	<li>1/2 beger Cherrytomater, delt i to</li>
	<li>1/2 beger Jordbær, delt i to</li>
	<li>1/2 Eple, i tynne båter</li>
	<li>Kraftkar eller annen god blåmuggost, i biter</li>
	<li>2-3 ss Gresskarkjerner, ristet i tørr panne</li>
	<li>ca. 4 ss God olivenolje</li>
	<li>ca. 2 ss God balsamicoeddik</li>
...
<<<<<<< HEAD
	<figure>
	<img class="matbilde" src="../img/sommersalat.jpg" width="500px" alt="sommersalat">
